...
±±ºPrograma  ³MT110ROT  ºAutor  ³Ricardo P. Sotomayorº Data ³  11/01/16   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³  Filtrar Botoes da rotina, baseado no perfil do solicitanteº±±
±±º          ³                                                            º±±
...
If !ExisteSX6("MV_FLMT110")
	CriarSX6("MV_FLMT110","C","Filtra Solicitaçoes de Compra","N")
EndIf
...
If GETMV("MV_APROVSC") .And. GetMV("MV_USAM110")== "S"
	...
	If SC1->(FieldPos("C1_HISTMOV")) > 0	
		AAdd( _aRotNew,{ "Histórico"	,"U_CONSC1('C1_HISTMOV')" 		   , 0 , 2, 0, nil } )
	EndIf	
Else                                                                                          
